...
public:
    struct stTransferLogRecord
    {
        ...
        string AccountTo;
        float Amount = 0.0f;
        float BalanceFrom = 0.0f;
        float BalanceTo = 0.0f;
        string Username;
    };
...
private:
    ...
    static stTransferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        TransferLogRecord.AccountFrom = vTransferLogRecord[1];
        TransferLogRecord.AccountTo = vTransferLogRecord[2];
        TransferLogRecord.Amount = stof(vTransferLogRecord[3]);
        TransferLogRecord.BalanceFrom = stof(vTransferLogRecord[4]);
        TransferLogRecord.BalanceTo = stof(vTransferLogRecord[5]);
    ...
    {
        string strDataLine = _PrepareTransferLogRecord(Amount, DestinationClient,UserName);
        fstream MyFile;
    ...
    static vector <stTransferLogRecord> GetTransferLogList()
    {
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                ...
                vTransferLogRecord.push_back(TransferLog);
            }
            MyFile.close();
        }
